...
public class Adapter_Booked_Room_List extends RecyclerView.Adapter<Adapter_Booked_Room_List.Room_List_View_Holder> implements Filterable {

    ArrayList<Model_Room_List> model_room_lists;
    ArrayList<Model_Room_List> model_another_room_lists;

    public Adapter_Booked_Room_List(ArrayList<Model_Room_List> model_room_lists) {
