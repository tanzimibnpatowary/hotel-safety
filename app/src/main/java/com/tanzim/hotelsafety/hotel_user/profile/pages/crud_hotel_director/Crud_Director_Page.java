...
public class Crud_Director_Page extends AppCompatActivity {
    ...
    private void submit_hotel_owner(String name, String address, String nid, String mobile, String politics) {
        ProgressDialog dialog = new ProgressDialog(Crud_Director_Page.this);
        dialog.setMessage("অপেক্ষা করুন....");
        dialog.show();

        RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext());
        String url = Constraint.HOTEL_SET_DIRECTOR_INFORMATION;
