...
public class Edit_Director_Info extends AppCompatActivity {
    ...
    private void update_hotel_owner(String name, String address, String nid, String mobile, String politics) {
        ...
        ProgressDialog dialog = new ProgressDialog(Edit_Director_Info.this);
        dialog.setMessage("অপেক্ষা করুন....");
        dialog.show();
        RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext());
        String url = Constraint.HOTEL_UPDATE_DIRECTOR_INFORMATION;
